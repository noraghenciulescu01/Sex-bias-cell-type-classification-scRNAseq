...
path = '/winhome/nghenciulescu/Desktop/chronic_rhinitis.h5ad'
...
to_remove = ['Alveolar fibroblasts', 'T cells proliferating', 'Migratory DCs', 'SMG serous (bronchial)', 'SMG serous (nasal)', 'Hillock-like', 'Tuft', 'Alveolar Mph CCL3+', 'Alveolar macrophages', 'Myofibroblasts', 'SMG mucous', 'Goblet (bronchial)', 'Plasmacytoid DCs', 'Non-classical monocytes', 'Subpleural fibroblasts', 'DC1', 'EC venous pulmonary', 'Pericytes', 'EC general capillary', 'Submucosal Gland', 'Multiciliated (nasal)']
