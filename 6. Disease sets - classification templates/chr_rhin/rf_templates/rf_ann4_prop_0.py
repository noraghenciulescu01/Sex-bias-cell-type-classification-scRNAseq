...
to_remove = ['Alveolar fibroblasts', 'T cells proliferating', 'Migratory DCs', 'Hillock-like', 'Tuft', 'Alveolar macrophages', 'SMG mucous', 'SMG serous', 'Plasmacytoid DCs', 'Non-classical monocytes', 'Subpleural fibroblasts', 'DC1', 'EC venous pulmonary', 'Pericytes', 'EC general capillary', 'Submucosal Gland']
adata = adata[~adata.obs["ann_level_4"].isin(to_remove)]
