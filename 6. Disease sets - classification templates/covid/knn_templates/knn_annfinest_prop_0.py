...
path = '/winhome/nghenciulescu/Desktop/covid.h5ad'
...
to_remove = ['AT2 proliferating','Alveolar fibroblasts', 'Neuroendocrine', 'Goblet (subsegmental)', 'Tuft', 'Club (nasal)', 'Myofibroblasts', 'Goblet (nasal)', 'SM activated stress response', 'Smooth muscle FAM83D+', 'Goblet (bronchial)', 'Subpleural fibroblasts', 'Multiciliated (nasal)']
