...
to_remove = ['AT2 proliferating', 'NK cells', 'T cells proliferating', 'Neuroendocrine', 'Migratory DCs', 'Plasma cells', 'Hillock-like', 'Deuterosomal', 'Lymphoid', 'DC1', 'EC general capillary']
